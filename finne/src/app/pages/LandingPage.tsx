...
export function LandingPage() {
  return (
    <div className="min-h-screen bg-linear-to-br from-[#0a0e1a] via-[#0f1420] to-[#0a0e1a]">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 backdrop-blur-xl bg-[#0a0e1a]/80 border-b border-[#c9a84c]/20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-full bg-linear-to-br from-[#c9a84c] to-[#3b82f6] flex items-center justify-center">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            >
              Banking for the
              <span className="block bg-linear-to-r from-[#c9a84c] to-[#3b82f6] bg-clip-text text-transparent">
                Digital Age
              </span>
            </h1>
            <p
          ...
          >
            <div className="absolute inset-0 bg-linear-to-r from-[#c9a84c]/20 via-[#3b82f6]/20 to-[#c9a84c]/20 blur-3xl" />
            <div className="relative h-full flex items-center justify-center">
              <div className="w-[400px] h-[250px] bg-linear-to-br from-[#c9a84c] to-[#b89640] rounded-2xl shadow-2xl p-8 backdrop-blur-xl border border-[#c9a84c]/30">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="p-8 rounded-2xl bg-linear-to-br from-[#141e32]/60 to-[#0a0e1a]/60 backdrop-blur-xl border border-[#c9a84c]/20 hover:border-[#c9a84c]/50 transition-all hover:scale-105"
              >
      ...
      <section
        id="how-it-works"
        className="py-20 px-6 bg-linear-to-br from-[#141e32]/40 to-transparent"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-linear-to-br from-[#c9a84c] to-[#b89640] flex items-center justify-center">
                  <span
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-linear-to-br from-[#c9a84c]/20 to-[#3b82f6]/20 blur-3xl" />
              <div className="relative p-12 rounded-2xl bg-linear-to-br from-[#141e32]/60 to-[#0a0e1a]/60 backdrop-blur-xl border border-[#c9a84c]/20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="p-8 rounded-2xl bg-linear-to-br from-[#141e32]/60 to-[#0a0e1a]/60 backdrop-blur-xl border border-[#c9a84c]/20"
              >
                <p
                  className="mb-6"
                  style={{
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-12 rounded-2xl bg-linear-to-br from-[#c9a84c]/20 to-[#3b82f6]/20 backdrop-blur-xl border border-[#c9a84c]/40">
            <h2
              className="font-heading mb-6"
              style={{ fontSize: "48px", color: "#ffffff" }}
            >
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-full bg-linear-to-br from-[#c9a84c] to-[#3b82f6] flex items-center justify-center">
